const signusfalcon = document.querySelector("#signusfalcon");
...
rj0001.addEventListener('click', () => {
    window.location.href = "/members/rj0001";
});

thisisausername.addEventListener('click', () => {
    window.location.href = "/members/thisisausername";
});
